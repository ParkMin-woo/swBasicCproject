...
// 1) 트리 구조로 구간 합 구하기 - 구간 합 트리 생성하기 [특정 범위 인덱스의 값을 저장]
#include <stdio.h>
#define NUMBER 7
...
void update(int start , int end , int node , int index , int dif) {
 ...
 // 4) 트리 구조로 구간 합 구하기 - 세그먼트 트리 사용해보기
int main(void) {
	// 구간 합 트리의 인덱스를 제외하고는 모든 인덱스는 0부터 시작합니다.
	// 구간 합 트리 생성하기
	init(0 , NUMBER - 1 , 1);
	// 구간 합 구하기
